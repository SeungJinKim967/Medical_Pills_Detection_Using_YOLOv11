...
if __name__ == "__main__":
    ...
    results = model.train(
        data=r'medical-pills.yaml',  # Path to the YAML file for Customer Monitoring
        epochs=200,               # Number of epochs
        imgsz=640,                # Image size
        batch=8,                  # Reduced batch size for memory saving
        name='medical-pills',  # Save name for the run
        device='0',               # Use GPU (set to '0' for first GPU, 'cpu' for CPU)
        project=r'medical-pills',  # Set the directory to save results on E drive
    ...
    model.save(r'medical_pills_model.pt')  # Save the model to E drive
    ...
    print("tensorboard --logdir D:/medical pillas/medical-pills/training_results/medical-pills")
